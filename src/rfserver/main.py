...
def main() -> None:
    ...
    parser = ArgumentParser(
        prog = "rfserver",
        usage="rfserver [-h] [-ld dir] [-v] [--version] [--author] [--report-bug] [--description] [--license] [--title] [--url]",
        description=" The server for Radio Frequency Scanner which capture given power threshold"
    )
